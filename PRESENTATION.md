# Marketplace REST API Application
## Full-Stack MVC Architecture with Node.js & MongoDB
...
A **full-stack marketplace application** where users can:
...
### Key Statistics
- **9 MongoDB Collections** (Users, Items, Reviews, Orders, etc.)
- **40+ REST API Endpoints**
- **Modern Tech Stack** (Express 5.1, Mongoose 8.18, Axios)
